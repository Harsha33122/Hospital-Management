async function login(event) {
    ...
    try {
        ...
        const response = await fetch('https://script.google.com/macros/s/AKfycbxLRsw-4ZzSpomobadNSTGbzQCi6bU6pQECcVvpOljbywDhrbvFPKIyJ8-ypVojwavdlA/exec'); // Replace with your web app URL
